	...
	var Video = function (_React$Component) {
	    ...
	    function Video() {
	        ...
	        _this.onMetaDataLoaded = function (e) {
	            _this._controlsWrapper.style.opacity = "1";
	        };
	        ...
	        _this.onTimeUpdate = function (e) {
	            ...
	            _this.setState({
	                ...
	                _this.seekProgressBarAppearance(_this._progress, percentage);
	            });
	        };
	
	        _this.onInput = function (e) {
	            _this.seekProgressBarAppearance(e.target, e.target.value);
	        };
	
	        _this.seekProgressBarAppearance = function (target, value, pattern) {
	            if (pattern === undefined) {
	                pattern = { name: "progress", colors: ["#A90329", "#6D0019", "rgba( 0, 0, 0, 0.4 )"] };
	            }
	            if (_this.props.style[pattern.name] === undefined) _this.props.style[pattern.name] = {};
	            var color = {
	                start: _this.props.style[pattern.name].startColor || _this.props.style[pattern.name].backgroundColor || _this.props.style[pattern.name].background || pattern.colors[0],
	                stop: _this.props.style[pattern.name].stopColor || _this.props.style[pattern.name].backgroundColor || _this.props.style[pattern.name].background || pattern.colors[1],
	                back: _this.props.style[pattern.name].back || pattern.colors[2]
	            };
	            var background = 'linear-gradient(to right, ' + color.start + ' 0%, ' + color.stop + ' ' + value + '%, ' + color.back + ' ' + value + '%, ' + color.back + ' )';
	        ...
	        _this.checkBuffer = function () {
	            ...
	            if (_this.lastBuffered != buffered) {
	                ...
	                _this.seekProgressBarAppearance(_this._buffer, percentage, {
	                    name: "buffer",
	                    colors: ["#666", "#666", "#000"]
	                });
	            }
	        ...
	        _this.getStyle = function () {
	            var style = {
	                video: _this.props.style.video || _this.props.style,
	                videoWrapper: _this.props.style.videoWrapper || {},
	                controlsWrapper: _this.props.style.controlsWrapper || {}
	            };
	            return style;
	        };
	                ...
	                _react2.default.createElement(
	                    'div',
	                    {
	                        ref: function ref(_ref3) {
	                            return _this2._controlsWrapper = _ref3;
	                        },
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement('input', { ref: function ref(_ref) {
	                                return _this2._buffer = _ref;
	                            }, type: 'range', step: '0.1', min: '0', max: '100', value: this.state.buffer, readonly: 'readonly', className: 'buffer' }),
	                        _react2.default.createElement('input', { ref: function ref(_ref2) {
	                                return _this2._progress = _ref2;
	                            }, type: 'range', step: '0.1', min: '0', max: '100', value: this.state.progress, onChange: this.onProgressChange, onInput: this.onInput, className: 'progress' })
	                    ),
	                    _react2.default.createElement('div', { className: 'volumeBar' }),
	                    _react2.default.createElement('div', { className: 'playButton' }),
	                    _react2.default.createElement('div', { className: 'pauseButton' }),
